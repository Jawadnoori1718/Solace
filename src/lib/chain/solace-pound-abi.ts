...
export const SOLACE_POUND_ABI = [
  ...
  {
    "inputs": [],
    "name": "InvalidEnergyAmount",
    "type": "error"
  },
  {
    "inputs": [],
    "name": "InvalidPotReference",
    "type": "error"
  },
  {
    "inputs": [],
