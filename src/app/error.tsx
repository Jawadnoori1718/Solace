  ...
  return (
    <main className="mx-auto flex max-w-xl flex-1 flex-col justify-center px-6 py-20">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        */}
        <button
          ...
          className="rounded-md border border-edge px-4 py-2 text-sm font-medium text-ink transition-colors hover:bg-sunken"
        >
      ...
      <details className="mt-8 border-t border-hairline pt-4">
        ...
        <p className="mt-2 break-words text-xs text-ink-muted">{error.message}</p>
        {error.digest !== undefined && (
          <p className="mt-1 tabular text-xs text-ink-muted">
            Digest {error.digest}
          </p>
        )}
      </details>
